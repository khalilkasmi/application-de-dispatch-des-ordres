    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $order->reference]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $order->reference]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $order->reference], ['confirm' => __('Are you sure you want to delete # {0}?', $order->reference)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
