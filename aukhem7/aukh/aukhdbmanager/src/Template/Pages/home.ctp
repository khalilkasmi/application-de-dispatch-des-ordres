...
$cakeDescription = 'AUKHEM7 - DB manager';
?>
<!DOCTYPE html>
<html>
<head>
...
<header class="row">
    <div class="header-image"><?= $this->Html->image('aukh-logo.png') ?></div>
    <div class="header-title">
        <h1>Welcome to Aukhem7 Database Manager</h1>
    </div>
</header>
<div class="row">
    <div class="column large-12 text-center">
        <h1>Start managing Database</h1>
    </div>
</div>
<div class="row">
    <div class="column large-12 text-center">
        <h4><a href="../Department">Department Table</a></h4>
        <h4><a href="../Employe">Users Table</a></h4>
        <h4><a href="../Order">orders Table</a></h4>
        <h4><a href="../Service">services Table</a></h4>
