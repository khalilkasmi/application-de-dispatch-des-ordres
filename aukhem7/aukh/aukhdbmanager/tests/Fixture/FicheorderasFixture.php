 ...
 *
 */
class FicheorderasFixture extends TestFixture
{
    ...
    public $fields = [
        'numorder' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fk3' => ['type' => 'foreign', 'columns' => ['reference'], 'references' => ['order', 'reference'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'numorder' => 'Lorem ipsum dolor sit amet',
